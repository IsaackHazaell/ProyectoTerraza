$('document').ready(function() {
  ...
  $.get( "https://donleonapi.herokuapp.com/provider", function( data ) {
    console.log(data);
    var html = ``;
  ...
  $('#delete').on('click', function() {
    $.each(cajas, function(index, value) {
      ...
      var bool = element.prop('checked');
      if(bool) {
        $.ajax({url: 'https://donleonapi.herokuapp.com/provider', method: 'delete', data: {id: element.val()}})
        .done(function(data) {
          console.log('data');
        });
      }
